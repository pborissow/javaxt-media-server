...
CREATE TABLE MEDIA_MATCH (
    ...
    MATCHING_ITEM_ID bigint NOT NULL,
    MATCH_INFO jsonb NOT NULL,
    IGNORE_MATCH boolean NOT NULL,
    CONSTRAINT PK_MEDIA_MATCH PRIMARY KEY (ID)
);
...
CREATE TABLE PERSON_FEATURE (
    ...
    PERSON_ID bigint NOT NULL,
    INFO jsonb,
    CONSTRAINT PK_PERSON_FEATURE PRIMARY KEY (ID)
);
...
CREATE TABLE FEATURE_MATCH (
    ID BIGSERIAL NOT NULL,
    FEATURE_ID bigint NOT NULL,
    MATCHING_FEATURE_ID bigint NOT NULL,
    MATCH_INFO jsonb NOT NULL,
    IGNORE_MATCH boolean NOT NULL,
    CONSTRAINT PK_FEATURE_MATCH PRIMARY KEY (ID)
);
...
ALTER TABLE MEDIA_MATCH ADD FOREIGN KEY (MEDIA_ITEM_ID) REFERENCES MEDIA_ITEM(ID)
    ON DELETE CASCADE ON UPDATE NO ACTION;

ALTER TABLE MEDIA_MATCH ADD FOREIGN KEY (MATCHING_ITEM_ID) REFERENCES MEDIA_ITEM(ID)
    ON DELETE CASCADE ON UPDATE NO ACTION;
...
ALTER TABLE PERSON_FEATURE ADD FOREIGN KEY (FEATURE_ID) REFERENCES FEATURE(ID)
    ON DELETE CASCADE ON UPDATE NO ACTION;

ALTER TABLE PERSON_FEATURE ADD FOREIGN KEY (PERSON_ID) REFERENCES PERSON(ID)
    ON DELETE CASCADE ON UPDATE NO ACTION;

ALTER TABLE PLACE_NAME ADD FOREIGN KEY (PLACE_ID) REFERENCES PLACE(ID)
    ON DELETE CASCADE ON UPDATE NO ACTION;

ALTER TABLE PLACE_MEDIA ADD FOREIGN KEY (MEDIA_ID) REFERENCES MEDIA_ITEM(ID)
    ON DELETE CASCADE ON UPDATE NO ACTION;

ALTER TABLE PLACE_MEDIA ADD FOREIGN KEY (PLACE_ID) REFERENCES PLACE(ID)
    ON DELETE CASCADE ON UPDATE NO ACTION;
...
ALTER TABLE FEATURE_MATCH ADD FOREIGN KEY (FEATURE_ID) REFERENCES FEATURE(ID)
    ON DELETE CASCADE ON UPDATE NO ACTION;

ALTER TABLE FEATURE_MATCH ADD FOREIGN KEY (MATCHING_FEATURE_ID) REFERENCES FEATURE(ID)
    ON DELETE CASCADE ON UPDATE NO ACTION;
...
CREATE INDEX IDX_MEDIA_ITEM_END_DATE ON MEDIA_ITEM(END_DATE);
CREATE INDEX IDX_MEDIA_ITEM_START_DATE ON MEDIA_ITEM(START_DATE);
...
CREATE unique INDEX IDX_MEDIA_MATCH ON MEDIA_MATCH(MEDIA_ITEM_ID, MATCHING_ITEM_ID);
...
CREATE unique INDEX IDX_PERSON_ADDRESS ON PERSON_ADDRESS(ADDRESS_ID, PERSON_ID);
...
CREATE INDEX IDX_PERSON_FEATURE_FEATURE ON PERSON_FEATURE(FEATURE_ID);
CREATE INDEX IDX_PERSON_FEATURE_PERSON ON PERSON_FEATURE(PERSON_ID);
CREATE unique INDEX IDX_PERSON_FEATURE ON PERSON_FEATURE(FEATURE_ID, PERSON_ID);
...
CREATE INDEX IDX_PLACE_MEDIA_MEDIA_ITEM ON PLACE_MEDIA(MEDIA_ID);
CREATE INDEX IDX_PLACE_MEDIA_PLACE ON PLACE_MEDIA(PLACE_ID);
CREATE unique INDEX IDX_PLACE_MEDIA ON PLACE_MEDIA(MEDIA_ID, PLACE_ID);
CREATE INDEX IDX_ADDRESS_PLACE ON ADDRESS(PLACE_ID);
CREATE INDEX IDX_FEATURE_MEDIA_ITEM ON FEATURE(ITEM_ID);
CREATE INDEX IDX_FEATURE_MATCH_FEATURE ON FEATURE_MATCH(FEATURE_ID);
CREATE INDEX IDX_FEATURE_MATCH_FEATURE2 ON FEATURE_MATCH(MATCHING_FEATURE_ID);
CREATE unique INDEX IDX_FEATURE_MATCH ON FEATURE_MATCH(FEATURE_ID, MATCHING_FEATURE_ID);
...
CREATE unique INDEX IDX_SETTING ON SETTING(KEY);
