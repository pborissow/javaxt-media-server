...
public class File extends javaxt.sql.Model {
  ...
  //**************************************************************************
    public File(){
        super("file", java.util.Map.ofEntries(
            
            java.util.Map.entry("name", "name"),
            java.util.Map.entry("extension", "extension"),
   ...
   */
    protected void update(Object rs) throws SQLException {
        ...
        try{
            ...
            this.extension = getValue(rs, "extension").toString();
   ...
   */
    public void update(JSONObject json){
        ...
        this.extension = json.get("extension").toString();
        if (json.has("path")){
